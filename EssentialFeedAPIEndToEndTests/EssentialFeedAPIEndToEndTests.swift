...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedResult(file _: StaticString = #file, line _: UInt = #line) -> FeedLoader.Result? {
    ...
    private func getFeedImageDataResult(file _: StaticString = #file, line _: UInt = #line) -> FeedImageDataLoader.Result? {
        let client = ephemeralClient()
